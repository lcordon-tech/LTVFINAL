...
# COMPLETO - CON AUTO-DETECCIÓN DE PATHS
# ============================================================================
"""
...
class Paths:
    ...
    def get_default_inputs_folder() -> Path:
        """Retorna la carpeta de inputs por defecto."""
        return Paths.get_project_root() / "inputs"
    ...
    def get_production_paths(country: str = "GT") -> PathsConfig:
        ...
        Si las rutas guardadas no existen, usa defaults.
        """
        ...
        default_inputs = Paths.get_default_inputs_folder()
