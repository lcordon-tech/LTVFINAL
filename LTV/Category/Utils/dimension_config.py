...
Permite agregar nuevas dimensiones (brand, product, collection, etc.)
con solo agregar una entrada en este diccionario.
"""
...
class DimensionMode(IntEnum):
    ...
    BRAND = 3
    PRODUCT = 4
    SUBCATEGORY_BRAND = 5      # Formato compuesto: "Subcategoría | Marca"
    SUBCATEGORY_MARCA_DUAL = 6  # NUEVO: dos columnas separadas
...
DIMENSION_CONFIGS: Dict[int, Dict[str, Any]] = {
    ...
    # NUEVO MODO DUAL: Subcategoría y Marca como columnas separadas
    DimensionMode.SUBCATEGORY_MARCA_DUAL: {
        'mode_id': 6,
        'group_by_attr': 'subcategory',  # Se agrupa por subcategoría
        ...
        'has_brand_column': True,      # ← Flag para modo dual
        'brand_column': 'Marca',
    },
}
